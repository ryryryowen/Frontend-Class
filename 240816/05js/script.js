...
// // 전개연산자
// const cheeseBurger = [...vegitable,...meatBurger;
...
let week = ["sunday", "mon", "tue", "wed", "thu", "fri", "sat"];
...
console.log(colors.slice(colors));
