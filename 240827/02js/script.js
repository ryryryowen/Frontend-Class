...
//  1. 60분법 : 인간의 편의 => 원 360도 // 몇도

// 2. 호도법 : 자연의 법칙
// 부채꼴 => 밑변(*반지름) = 호의 둘레와 같다면, 무조건 해당 부채꼴 내각은 57.296도 = 1 래디언
// 3.14 = 180도 = 파이
// 3래디언 = 171.888
//  8.112
...
// storokeRect(x, y, width, height) : 사각형 아웃라인 선을 그려주도록하는 함수

// clearRect(x, y, width. height) : 사각형 형태의 특정 요소만큼을 지우고자할 때 사용하는 함수

// 사각형을 만들고자 할 때 사용할 수 있는 속성

// fillStyle = "색상" : 해당 도형의 생상을 채울 때 사용할 수 있는 속성
