...
//  react는 기본적으로 브라우저를 통해서 앱을 여는 순간 => 컴포넌트가 무조건 마운트가 됨!!
// 가상돔 => 영화데이터를 찾아오도록하는 fetch()
// 정상적으로 fetch()를 통해서 불러오는 영화 API 데이터를 출력하지못함 !!

// 찾아온 영화데이터를 가지고 약 3000픽셀 높이값을 가지고있는 브라우저 화면을 채워야하는 상황
//  => 20개
...
// const element = arr.find((item) => item.name === "염크스");
// console.log(element);

const arr = [
  { name: "슛돌이 염동훈", hobby: "조기축구" },
  { name: "피구왕 염키", hobby: "피구" },
  { name: "야구왕 염제스", hobby: "야구" },
  { name: "등산맨 염치뚜치", hobby: "피구" },
];
