...
import WeatherBox from "./compomrmts/WeatherBox";
import WeatherButton from "./compomrmts/WeatherButton";
      ...
      <Wrapper img={background}>
        <Contents>
          ...
          <WeatherButton
            cities={cities}
            setCity={setCity}
            hadleCityChange={hadleCityChange}
          />
        </Contents>
      </Wrapper>
    </>
