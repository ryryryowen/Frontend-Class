...
class StudentDeveloper extends Student {
  ...
  programming() {
    console.log(`${this.favoritSkill}로 축구 합니다!`);
  }
}

const studentC = new StudentDeveloper("Ronaldo", 40, 2, "Siuuuuuu");

console.log(studentC.programming());

// 접근제어자 3개
// pubilc : 모든 범위에서 접근할 수 있도록(기본 default)
// private : 클래스 내부에서만 접근 가능
// protected : 클래스 내부 & 상속받은 파생클래스 접근
